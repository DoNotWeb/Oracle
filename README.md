<div align="center">
  ...
  <h1>Oracle Userbot</h1>
  <p>Advanced Telegram userbot with enhanced security and modern features</p>
  
  <p>
    <a href="https://www.codacy.com/gh/DoNotWeb/Oracle/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=DoNotWeb/Oracle&amp;utm_campaign=Badge_Grade">
      <img src="https://app.codacy.com/project/badge/Grade/97e3ea868f9344a5aa6e4d874f83db14" alt="Codacy Grade">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/languages/code-size/DoNotWeb/Oracle" alt="Code Size">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/issues-raw/DoNotWeb/Oracle" alt="Open Issues">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/license/DoNotWeb/Oracle" alt="License">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/commit-activity/m/DoNotWeb/Oracle" alt="Commit Activity">
    </a>
    <br>
    <a href="#">
      <img src="https://img.shields.io/github/forks/DoNotWeb/Oracle?style=flat" alt="Forks">
    </a>
    <a href="#">
      <img src="https://img.shields.io/github/stars/DoNotWeb/Oracle" alt="Stars">
    </a>
...
> While Oracle implements extended security measures, installing modules from untrusted developers may still cause damage to your server/account.
> 
> **Recommendations:**
...
git clone https://github.com/DoNotWeb/Oracle && \
cd Oracle && \
...
[![Telegram Support](https://img.shields.io/badge/Telegram-Support_Group-2594cb?logo=telegram)](https://t.me/oracle_talks)
...
- [**Lonami**](https://t.me/lonami) for Telethon (Oracle-TL backbone)

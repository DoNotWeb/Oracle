    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                self._client,
                "oracle-assets",
                "🌆 Your Oracle assets will be stored here",
                archive=True,
                avatar="https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/oracle_assets.png"
            )
    ...
    def read(self):
        ...
        try:
            ...
            if re.search(r'"(hikka\.)(\S+\":)', db):
                ...
                db = re.sub(r'(hikka\.)(\S+\":)', lambda m: 'oracle.' + m.group(2), db)

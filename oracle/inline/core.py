...
class InlineManager(
    ...
    :type db: oracle.database.Database
    :type allmodules: oracle.loader.Modules
    """
    ...
    def __init__(
        ...
        self._token = db.get("oracle.inline", "bot_token", False)
    ...
    async def register_manager(
        ...
        self._name = get_display_name(self._client.oracle_me)
        ...
        try:
            m = await self._client.send_message(self.bot_username, "/start oracle init")
            ...
            try:
                m = await self._client.send_message(
                    self.bot_username, "/start oracle init"
                )
            except Exception:

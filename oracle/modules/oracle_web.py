...
@loader.tds
class OracleWebMod(loader.Module):
    """Web/Inline mode add account"""

    strings = {"name": "OracleWeb"}
    ...
    async def weburl(self, message: Message, force: bool = False):
        ...
        if "OTHERHOST" in os.environ or "JAMHOST" in os.environ:
            ...
            if "LAVHOST" in os.environ:
                form = await self.inline.form(
                    ...
                    reply_markup={
                       ...
                       "url": await main.oracle.web.get_url(proxy_pass=False),
                    },
            ...
            if (
                ...
                try:
                    if not await self.inline.form(
                        ...
                        photo="https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/web_interface.png",
                    ):
                        raise Exception
                except Exception:
                    await utils.answer(
            ...
            if not main.oracle.web:
                main.oracle.web = core.Web(
                    data_root=main.BASE_DIR,
                    api_token=main.oracle.api_token,
                    proxy=main.oracle.proxy,
                    connection=main.oracle.conn,
                )
                await main.oracle.web.add_loader(self._client, self.allmodules, self._db)
                await main.oracle.web.start_if_ready(
                    len(self.allclients),
                    main.oracle.arguments.port,
                    proxy_pass=main.oracle.arguments.proxy_pass,
                )
            ...
            if force:
                ...
                await form.edit(
                    ...
                    photo=(
                        "https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/opening_tunnel.png"
                    ),
                )
            else:
                form = await self.inline.form(
            ...
            url = await main.oracle.web.get_url(proxy_pass=True)

            await form.edit(
                self.strings("tunnel_opened"),
                reply_markup={"text": self.strings("web_btn"), "url": url},
                photo="https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/tunnel_opened.png",
            )
    ...
    def _get_client(self) -> CustomTelegramClient:
        return CustomTelegramClient(
            MemorySession(),
            main.oracle.api_token.ID,
            main.oracle.api_token.HASH,
            connection=main.oracle.conn,
            proxy=main.oracle.proxy,
    ...
    async def schedule_restart(self, call, client):
        ...
        await main.oracle.save_client_session(client, delay_restart=False)
        restart()

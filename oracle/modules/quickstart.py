...
class Quickstart(loader.Module):
    ...
    async def client_ready(self):
        await self.request_join(
            "oracle_talks", 
            "Oracle help is only available in this chat. By agreeing to join the chat, you agree to the Oracle federation rules and if you violate them, you will be permanently banned."
        )
    ...
    async def lang(self, call: BotInlineCall):
        if not call.data.startswith("oracle/lang/"):
            return

...
class CoreMod(loader.Module):
    ...
    @loader.command(ru_doc="Информация о Хероку", en_doc="Information of Oracle", ua_doc="Інформація про Хероку", de_doc="Informationen über Oracle")
    async def oraclecmd(self, message: Message):
        await utils.answer(
            message,
            self.strings("oracle").format(
                (
                    utils.get_platform_emoji()
                    if self._client.oracle_me.premium and CUSTOM_EMOJIS
                    else "🪐 <b>Oracle userbot</b>"
                ),
                *version.__version__,
            ...
            file= "https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/oracle_cmd.png",
    ...
    async def installationcmd(self, message: Message):
        ...
        if (not args or args not in {'-vds', '-wsl', '-ul', '-jh', '-hh', '-lh'}) and \
            not (await self.inline.form(
                ...
                photo="https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/oracle_installation.png",
            ...
            await self.client.send_file(
                message.peer_id,
                "https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/oracle_installation.png",

...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Oracle will try to determine, which client caused logs. E.g. there"
                    ...
                    " Oracle will send all logs to Client1 and Client2, even if it is"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/DoNotWeb/Oracle/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "oracle-logs",
            "🪐 Your Oracle logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar="https://raw.githubusercontent.com/DoNotWeb/assets/refs/heads/main/oracle/oracle_logs.png",
        )
